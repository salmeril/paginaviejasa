...
If (CStr(Request("MM_update")) <> "" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_fields = "nombre,nombre,',none,'',apellido,apellido,',none,'',email,email,',none,'',contestacion,contestacion,',none,'',fechaenvio,fechaenvio,#,none,NULL,enviado,enviado,',none,''"
