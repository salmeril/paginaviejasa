...
q= "SELECT * FROM noticias WHERE  id=" & Request("id")
...
topico = rs("topico").value   %> 
            <table border="0" width="100%">
              <tr> 
                <td width="20">&nbsp;</td>
                <td height="30"> 
                  <p><font face="Arial, Helvetica, sans-serif"><b><b><font color="#800040">IMPORTANTES 
                    NOVEDADES </font></b> <font color="#800040">:</font></b></font> 
                  <p><font face="Arial, Helvetica, sans-serif"><font face="Arial" color="#004080"><i><strong><%=titulo%></strong></i></font></font> 
                </td>
              </tr>
              <tr> 
