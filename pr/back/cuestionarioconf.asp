...
if(session("svID") <> "") then rscuestionario__MMColParam = session("svID")
...
objMail.From = "system"
objMail.To = "nuestramedicina@hotmail.com"
objMail.Subject = "Nuevo cuestionario"
objMail.Body = "para ver los cuestionarios haga click aqui     http://www.nuestramedicina.com/pr/cuestionarioall.asp"
objMail.Send
 %> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
        ...
        <tr align="center"> 
          <td> 
            ...
            <table width="90%" border="0">
              <tr> 
                <td> 
                  <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Muchas 
                    gracias,</font></p>
                  <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                    Le agradezco su confianza, una vez analizado y evaluado su 
                    cuestionario y pregunta le enviaré una contestación.</font></p>
                  <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                    Atentamente, </font></p>
                  <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><i>Dr. 
                    Armoza</i></font></p>
                </td>
              </tr>
              <tr> 
