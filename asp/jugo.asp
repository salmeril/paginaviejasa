...
q= "SELECT * FROM jugos WHERE nombre='" & Request("nombre")& "'"
  ...
  nombre = rs("nombre").value   %> 
                  <table border="0" width="100%">
                    <tr> 
                      <td width="20">&nbsp;</td>
                      <td height="30"> 
                        <p><font face="Arial, Helvetica, sans-serif"><b><font color="#800040">JUGOS: 
                          </font></b><font color="#004080"><i><font face="Arial"><strong><%=nombre%></strong></font></i></font></font> 
                      </td>
                    </tr>
                    <tr> 
                      ...
                      <td> 
                        <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=rs("ingredientes")%></font> 
                    ...
                    <tr> 
                      ...
                      <td height="5" align="center"> 
                        <table width="75%" border="0" cellpadding="5" cellspacing="5">
                          <tr align="center" bgcolor="#DEDEEF"> 
                            <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><font color="#004080">UNO 
                              A DOS POR DIA SOLAMENTE, PUEDE AGREGAR MANZANA FRESCA 
                              O LIMON Y AGUA DESTILADA, USAR EXTRACTORA Y SI USA 
                              LICUADORA COLAR LOS JUGOS CON EL AGUA DESTILADA</font></font></td>
                          </tr>
                        </table>
                      </td>
                    </tr>
