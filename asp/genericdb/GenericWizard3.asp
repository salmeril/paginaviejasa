...
' Revision History:
' 15 Jul 1999 - Commented the Response.Clear line. Some people Save this page rather than 
'				cut & paste it into their editors as directed. Such saved files have HTML headers
'				and therefore do not work with Response.Clear. 
...
<%
' Display the file
Response.Write("<font color='green'>&lt;!-- Cut and paste the following Config File into your editor and save it. <br>Make a link to this new file to access your database. --&gt;</font>" & "<BR>")
Response.Write("&lt;" & "%<BR>")
...
Response.Write("Session(" & QUOTE & "dbExitPageText" & QUOTE & ") = " & QUOTE & Session("dbExitPageText") & QUOTE & "<BR>")
...
' Response.Write("Response.Clear") & "&lt;BR&gt;"
