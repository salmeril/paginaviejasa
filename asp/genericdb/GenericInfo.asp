...
' 28 Jun 1999 - Query displayed in SELECT...FROM...WHERE...GROUPBY...ORDERBY format
' 15 Apr 1999 - Support for dbBorderColor and dbMenuColor
...
<TR><TD BGCOLOR=<%=strMenuColor%> ALIGN="RIGHT" WIDTH="*"><FONT SIZE=3 FACE="<%=strFont%>">
