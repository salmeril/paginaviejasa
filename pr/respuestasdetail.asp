        ...
        <tr> 
          ...
          <td height="30"> 
            ...
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Si 
              vive en los Estados Unidos y desea una consulta en la Clinica del 
              Dr. Armoza, personalmente o por telefono, por favor llame gratis 
              (sin cargo para su telefono) al <b>1-800-522-7099.</b> <br>
              </font><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Si 
              vive fuera de los Estados Unidos llame al 1-718-651-6677.<br>
              </font><br>
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Si 
              viene a la Clinica no se olvide de traer, si los tiene todos los 
              estudios de su medico primario y hospital, medicamentos o productos 
              naturales que este tomando y MUY IMPORTANTE una lista de todos los 
              sintomas que tenga aunque no parezcan relacionados con el principal 
              problema que lo aqueja.</font>
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Gracias, 
              Dr. Armoza </font>
            <p><% if (rsrecomendados.Fields.Item("total").Value)<>0 then %> 
              <font face="Verdana, Arial, Helvetica, sans-serif" size="2">En caso 
              que no puede venir, ordene los siguientes producto</font> 
