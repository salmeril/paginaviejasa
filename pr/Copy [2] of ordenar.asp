    ...
    <td align="left" valign="top"><!-- #BeginEditable "contenido" --> 
      <table border="0" width="100%">
        ...
        <tr> 
          <td width="20"></td>
          <td height="30"> 
            <form name="form1" method="post" action="ordenar1.asp" onSubmit="MM_validateForm('name','','R','apellido','','R','email','','RisEmail','direccion','','R','ciudad','','R','estado','','R','codigo','','R','telefono','','R','numero','','R','fecha','','R');return document.MM_returnValue">
              <p> 
              ...
              <p>&nbsp;</p>
              <pre>Nombre:    <input type="text" name="name" size="20" width="<%= Session("nombre") %>">  Apellido:  <input type="text" name="apellido" size="20">
...
Tipo de Tarjeta:     <select name="tipo" size="1"><option>Visa</option><option>Mastercard</option><option>American Express</option><option>Discover</option></select>
Numero de Tarjeta:   <input type="text" name="numero" size="30">
Fecha de expiración: <input type="text" name="fecha" size="20" onBlur="MM_validateForm('fecha','','R');return document.MM_returnValue">

Comentarios:
<textarea name="comentarios" cols="50"></textarea>

<input type="submit" name="mandar" value="Mandar"></pre>
            </form>
<p>&nbsp; 
          </td>
        </tr>
