...
nombre = (rsordenes.Fields.Item("nombre").Value)
apellido= (rsordenes.Fields.Item("apellido").Value)
email =(rsordenes.Fields.Item("email").Value)
direccion =(rsordenes.Fields.Item("direccion").Value)
ciudad =(rsordenes.Fields.Item("ciudad").Value)
estado = (rsordenes.Fields.Item("estado").Value)
codigo= (rsordenes.Fields.Item("codigo").Value)
telefono=(rsordenes.Fields.Item("telefono").Value)
tipo =(rsordenes.Fields.Item("tarjeta").Value)
numero = (rsordenes.Fields.Item("numero").Value)
fecha= (rsordenes.Fields.Item("fecha").Value)
comentarios= (rsordenes.Fields.Item("comentarios").Value)
productos=(rsordenes.Fields.Item("productos").Value)
total=(rsordenes.Fields.Item("total").Value)


Set objMail = CreateObject("CDONTS.Newmail")
objMail.From =email
objMail.To = "myung@paradero.com"
objMail.Subject = "Orden"

sHTML = "id: " &id & vbCrLf
sHTML = sHTML & "nombre: " & nombre & vbCrLf
sHTML = sHTML & "apellido: " &apellido & vbCrLf
sHTML = sHTML & "direccion: " & direccion & vbCrLf
sHTML = sHTML & "ciudad: " & ciudad & vbCrLf
sHTML = sHTML & "estado: " & estado & vbCrLf
sHTML = sHTML & "codigo: " & codigo & vbCrLf
sHTML = sHTML & "telefono: " & telefono & vbCrLf
sHTML = sHTML & "email: " & email & vbCrLf& vbCrLf

sHTML = sHTML & "tipo de tarjeta: " &tipo & vbCrLf
sHTML = sHTML & "numero de tarjeta: " &numero & vbCrLf
sHTML = sHTML & "fecha de expiracion: " & fecha & vbCrLf& vbCrLf

sHTML = sHTML & "comentarios: " & comentarios & vbCrLf& vbCrLf

sHTML = sHTML & "productos: " & productos & vbCrLf
sHTML = sHTML & "total: " & total & vbCrLf

objMail.Body = sHTML 
objMail.Send
  %></p>
            <p><font face="Arial, Helvetica, sans-serif"><font face="Verdana, Arial, Helvetica, sans-serif">Su 
              numero de orden es:<b><%=(rsordenes.Fields.Item("ID").Value)%></b></font></font></p>
            <p><font face="Verdana, Arial, Helvetica, sans-serif"><b>$<%=(rsordenes.Fields.Item("total").Value)%>+$10</b> 
              (gastos de envio)<br>
              seran cargados en su tarjeta de credito</font></p>
            <p>&nbsp;</p>
            <p><font face="Verdana, Arial, Helvetica, sans-serif">PARA CUALQUIER 
              PREGUNTA PUEDE LLAMAR AL</font></p>
            <p><font face="Verdana, Arial, Helvetica, sans-serif"><br>
              <b>1-800-522-7099</b></font></p>
