...
objMail.Body = "para ver la respuesta a su cuestionario haga click aqui     http://www.nuestramedicina.com/pr/detalle.asp?id=" & id
objMail.Send
  %><font face="Arial, Helvetica, sans-serif"><b><font face="Verdana, Arial, Helvetica, sans-serif"><br>
      ...
      <form name="form1" method="post" action="<%=MM_editAction%>">
        ...
        <input type="submit" name="Submit" value="Actualizar Cuestionario">
