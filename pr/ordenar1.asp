...
objMail.From = "system"
objMail.To = "powernatural@hotmail.com"
objMail.Subject = "Nueva orden"
objMail.Body = "para ver la orden haga click aqui     http://www.nuestramedicina.com/pr/ordendetail.asp?id=" & vid
objMail.Send
 %> 
            </p>
            ...
            <p><br>
              ...
              aqui</a> <br>
              y complete el formulario de la siguiente manera:<br>
              Pay to: <b>NATURAL POWER</b><br>
              Code City: <b>ARMOZA</b><br>
              State: <b>NY</b><br>
              <% else %> 
