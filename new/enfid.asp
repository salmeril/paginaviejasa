  ...
  nombre = rs("nombre").value   %> 
                ...
                <table width="200" border="0" cellspacing="5">
                  ...
                  <tr> 
                    ...
                    <td align="center" width="1" bgcolor="#333366">&nbsp;</td>
                    <td width="189"> 
                      <a href="enft1.asp?id=<%=RS("id")%>"><%=RS("titulo1")%></a> 
                      <%end if%>
                      </td>
                  </tr>
                  <tr> 
                    ...
                    <td align="center" width="1" bgcolor="#333366">&nbsp;</td>
                    <td width="189"> 
                      <a href="enft2.asp?id=<%=RS("id")%>"><%=RS("titulo2")%></a> 
                      <%end if%>
                      </td>
                  </tr>
                  <tr> 
                    ...
                    <td align="center" width="1" bgcolor="#333366">&nbsp;</td>
                    <td width="189"> 
                      <a href="enft3.asp?id=<%=RS("id")%>"><%=RS("titulo3")%></a> 
                      <%end if%>
                      </td>
                  </tr>
                  <tr> 
                    ...
                    <td align="center" width="1" bgcolor="#333366">&nbsp;</td>
                    <td width="189"> 
                      <a href="enft4.asp?id=<%=RS("id")%>"><%=RS("titulo4")%></a> 
                      <%end if%>
                      </td>
                  </tr>
                  <tr> 
                    ...
                    <td align="center" width="1" bgcolor="#333366">&nbsp;</td>
                    <td width="189"> 
                      <a href="enft5.asp?id=<%=RS("id")%>"><%=RS("titulo5")%></a> 
                      <%end if%>
                      </td>
                  </tr>
                  <tr> 
                    ...
                    <td align="center" width="1" bgcolor="#333366">&nbsp;</td>
                    <td width="189"> 
                      <a href="enft6.asp?id=<%=RS("id")%>"><%=RS("titulo6")%></a> 
                      <%end if%>
                     </td>
                  </tr>
                  <tr> 
                    ...
                    <td align="center" width="1" bgcolor="#333366">&nbsp;</td>
                    <td width="189">
                      <a href="enft7.asp?id=<%=RS("id")%>"><%=RS("titulo7")%></a> 
                      <%end if%>
                      </td>
                  </tr>
                  <tr> 
                    ...
                    <td align="center" width="1" bgcolor="#333366">&nbsp;</td>
                    <td width="189">
                      <a href="enft8.asp?id=<%=RS("id")%>"><%=RS("titulo8")%></a> 
                      <%end if%>
                      </td>
                  </tr>
                  <tr> 
                    ...
                    <td align="center" width="1" bgcolor="#333366">&nbsp;</td>
                    <td width="189">
                      <a href="enft9.asp?id=<%=RS("id")%>"><%=RS("titulo9")%></a> 
                      <%end if%>
                      </td>
                  </tr>
                  <tr> 
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr align="center"> 
                    <td> <table width="100%" border="0">
                        <tr> 
                          <td width="20">&nbsp;</td>
                          <td height="30"> <div align="left"><b><font color="#800040">ENFERMEDADES:</font></b> 
                              <font face="Arial" color="#004080"><i><%=nombre%></i></font></div></td>
                        </tr>
                        <tr> 
                          <td width="20">&nbsp;</td>
                          <td> <p align="left"><b>CONCEPTO </b></p>
                            <p align="left"><%=RS("concepto")%></p></td>
                        </tr>
                        <tr> 
                          <td width="20">&nbsp;</td>
                        ...
                        <tr> 
                          <td width="20">&nbsp;</td>
                          <td><div align="left"> 
                              <%if trim(rs("musica"))<>"" then%>
                              <a href="javascript: Play('<%=rs("musica")%>')"><img src="/images/speaker1.gif" width="16" height="13" border="0"></a> 
                              <%end if%>
                            </div></td>
                        </tr>
                        <tr> 
                          <td width="20">&nbsp;</td>
                          <td height="3"> <p align="left">&nbsp;</p></td>
                        </tr>
                      </table></td>
                  </tr>
                </table>				
