...
If (CStr(Request("MM_insert")) <> "") Then
  ...
  MM_fields = "fecha,fecha,#,none,NULL,id,ID,none,none,NULL,enviado,enviado,',none,'',nombre,nombre,',none,'',apellido,apellido,',none,'',email,email,',none,'',contestacion,contestacion,',none,'',productos,productos,',none,'',total,total,none,none,NULL"
