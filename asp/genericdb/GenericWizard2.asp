...
<TR><TD COLSPAN=9 ALIGN=CENTER BGCOLOR=<%=MenuColor%>><FONT SIZE=<%=FontSize%> FACE="<%=Font%>"><STRONG>- <%= Rs %> -</STRONG></TD></TR>
<TR>
	<TH colspan=4>&nbsp;</TH>
...
<%		Case 129, 200, 201, 202, 203 ' Char, VarChar, LongVarChar (Memo), VarWChar (Unicode String), LongVarWChar %>
			<INPUT TYPE="Text" NAME="Default<%=x%>" VALUE="''" SIZE="20" MAXLENGTH="40">
<%	End Select %>
		</FONT></TD>
