                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr align="center"> 
                    <td> <table border="0" width="100%">
                        ...
                        <tr> 
                          <td width="20">&nbsp;</td>
                          <td><div align="left"><b><%=RS("titulo11")%></b> </div>
                            <p align="left"><%=RS("contenido11")%> </td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                          <td height="5">&nbsp;</td>
                        ...
                        <tr> 
                          <td width="20">&nbsp;</td>
                          <td height="5"><b><font color="#666666"><i>Según los 
                            síntomas que describa el paciente en consulta, como 
                            se vea la lengua, estudios del medico primario, y 
                            los pulsos que se toman en ambas muñecas se definirá 
                            el diagnóstico. Dependiendo el diagnóstico se definirá 
                            el tratamiento con acupuntura, hierbas chinas, dieta 
                            oriental y ejercicios recomendados. La clave es un 
                            buen diagnóstico. Medico oriental que ataca los síntomas 
                            para calmar se llama medico menor. El que ataca el 
                            origen de los síntomas para curar que presenta el 
                            paciente se llama Medico Mayor o Master en Medicina 
                            Tradicional China.</i></font></b></td>
                        </tr>
                      </table></td>
                  </tr>
                </table>			  
