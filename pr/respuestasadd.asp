...
If (CStr(Request("MM_insert")) <> "") Then
  ...
  MM_fields = "fecha,fecha,#,none,NULL,id,ID,none,none,NULL,enviado,enviado,',none,'',lugar,lugar,',none,'',nombre,nombre,',none,'',apellido,apellido,',none,'',email,email,',none,'',contestacion,contestacion,',none,''"
