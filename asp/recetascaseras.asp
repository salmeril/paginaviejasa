...
q= "SELECT * FROM recetascaseras ORDER BY receta"
rs.Open q, "DSN=7598.medicina;"

   %> 
            <p><%if rs.EOF then%><font face="Verdana, Arial, Helvetica, sans-serif">No 
              hay ninguna Receta Casera</font>&nbsp; <%else%> </p>
            <table border="0" width="100%">
              <tr> 
                <td width="20">&nbsp;</td>
                <td height="30"> 
                  <p><font face="Arial, Helvetica, sans-serif"><b><font color="#800040">RECETAS CASERAS</font></b></font> 
                </td>
              </tr>
              <% while NOT rs.EOF %> 
              <tr> 
                ...
                <td> 
                  <p><a href="rcid.asp?id=<%=RS("id")%>"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=RS("receta")%></font></a> 
