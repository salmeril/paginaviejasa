                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr align="center"> 
                    <td> <table border="0" width="100%">
                        <tr> 
                          <td width="20">&nbsp;</td>
                          <td><div align="left"><b><font color="#800040">ENFERMEDADES:</font></b><b><font color="#333333"> 
                              </font></b><font color="#000080"><strong><font color="#004080"><i><%=nombre%></i></font></strong></font> </div></td>
                        </tr>
                        <tr> 
                          <td width="20">&nbsp;</td>
                          <td><div align="left"><b><%=RS("titulo1")%></b></div>
                            <p align="left"><%=RS("contenido1")%> </td>
                        </tr>
                        <tr> 
                          <td width="20">&nbsp;</td>
                          <td height="5">&nbsp;</td>
