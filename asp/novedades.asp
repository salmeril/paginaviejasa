...
//--></script><!--webbot BOT="GeneratedScript" endspan --><form method="POST" action="/asp/enfnom.asp" onsubmit="return FrontPage_Form1_Validator(this)" name="FrontPage_Form1" language="JavaScript">
  ...
  <tr> 
    ...
    <td align="left" valign="top"><!-- #BeginEditable "contenido" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr align="center"> 
          <td height="20"><font face="Arial, Helvetica, sans-serif"><b>
            <%
Set rs = Server.CreateObject("ADODB.RecordSet")
q= "SELECT * FROM noticias ORDER BY titulo"
   ...
   %>
        ...
        <tr align="center">
          <td><table border="0" width="100%">
              <tr> 
                <td width="20">&nbsp;</td>
                <td height="30"> <p><font face="Arial, Helvetica, sans-serif"><b><font color="#800040">IMPORTANTES 
                    NOVEDADES</font></b></font></td>
              </tr>
              <tr> 
                <td align="right"><div align="center"><img src="/images/bullet.gif" width="6" height="6"></div></td>
                <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a href="../news/Index.html">Microsite 
                  de novedades de Cesar Armoza</a></font></td>
              </tr>
              <tr> 
                <td align="right"><div align="center"><img src="/images/bullet.gif" width="6" height="6"></div></td>
                <td><a href="../prostate/index.htm"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Investigaci&oacute;n 
                  de pacientes con problema de pr&oacute;stata conducido por Columbia 
                  Presbyterian Medical Center (en ingles)</font></a></td>
              </tr>
        ...
        <tr align="center"> 
          <td> <p> 
            ...
            <table border="0" width="100%">
              <% while NOT rs.EOF %>
              <tr> 
                <td width="20" align="right"> <p><img src="/images/bullet.gif" width="5" height="5"><font face="Verdana, Arial, Helvetica, sans-serif"> 
                    </font> </td>
                <td> <p><a href="/asp/novid.asp?id=<%=RS("id")%>"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=RS("titulo")%></font></a> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                    </font> </td>
              </tr>
              <%
                rs.MoveNext
