...
<title>Enfermedades resultados busqueda</title>
<!-- #EndEditable --> 
...
q= "SELECT DISTINCT enfermedades.nombre, enfermedades.id FROM sintomas INNER JOIN Enfermedades ON sintomas.Enfid = Enfermedades.ID WHERE (sintomas.nombre LIKE '" & nombre & "%') ORDER BY enfermedades.nombre"
rs.Open q, "DSN=7598.medicina;"

%> 
            <p><%if rs.EOF then%><font face="Verdana, Arial, Helvetica, sans-serif">No 
              hay ninguna enfermedad</font>&nbsp; <%else%> </p>
            <table border="0" width="100%">
              <tr> 
                <td width="20">&nbsp;</td>
                <td height="30"> 
                  <p><font face="Arial, Helvetica, sans-serif"><b><font color="#800040">ENFERMEDADES</font></b></font> 
                </td>
              </tr>
              <%while NOT rs.EOF%> 
              <tr> 
                ...
                <td> 
                  <p><a href="enfid.asp?id=<%=RS("id")%>"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=RS("nombre")%></font></a> 
