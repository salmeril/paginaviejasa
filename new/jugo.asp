...
rs.Open q, "DSN=7598.medicina;"
  nombre = rs("nombre").value   %>
                            <table border="0" width="100%">
                              <tr> 
                                <td width="20">&nbsp;</td>
                                <td height="30"> <p align="left"><b><font color="#800040">JUGOS</font></b><b><font color="#800040">: 
                                    </b><font color="#004080"><i><strong><%=nombre%></strong></i></font></font> 
                                  </p></td>
                              </tr>
                              <tr> 
                                <td width="20" align="right"> <p><font face="Verdana, Arial, Helvetica, sans-serif"> 
                                    </font> </p></td>
                                <td> <p align="left"><%=rs("ingredientes")%> </p></td>
                              </tr>
                              <tr> 
                              ...
                              <tr> 
                                <td width="20" align="right">&nbsp;</td>
                                <td height="5" align="center"> <table width="75%" border="0" cellpadding="5" cellspacing="5">
                                    <tr align="center" bgcolor="#DEDEEF"> 
                                      <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><font color="#004080">UNO 
                                        A DOS POR DIA SOLAMENTE, PUEDE AGREGAR 
                                        MANZANA FRESCA O LIMON Y AGUA DESTILADA, 
                                        USAR EXTRACTORA Y SI USA LICUADORA COLAR 
                                        LOS JUGOS CON EL AGUA DESTILADA</font></font></td>
                                    </tr>
                                  </table></td>
                              </tr>
                              <tr> 
                    ...
                    <td align="center" valign="top" width="20%"> <table width="100%" border="0" cellspacing="5" cellpadding="5">
                        <tr align="center"> 
