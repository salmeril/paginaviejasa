...
Estado: <b><%=(rscuestionario.Fields.Item("estado").Value)%></b>    Código: <b><%=(rscuestionario.Fields.Item("codigo").Value)%></b><br>Lugar de residencia: <b><%=(rscuestionario.Fields.Item("lugar").Value)%></b><br>Teléfono: <b><%=(rscuestionario.Fields.Item("telefono").Value)%></b><br>Email:    <b><%=(rscuestionario.Fields.Item("email").Value)%></b>
...
Problema principal y pregunta? <br><textarea name="pregunta" cols="70" rows="5" wrap="PHYSICAL"><%=(rscuestionario.Fields.Item("pregunta").Value)%></textarea>
...
<b><%=(rscuestionario.Fields.Item("importante").Value)%></b>
              ...
              <%Session("svnombre")= (rscuestionario.Fields.Item("nombre").Value) %> 
              <%Session("svapellido")= (rscuestionario.Fields.Item("apellido").Value) %> 
              <%Session("svemail")= (rscuestionario.Fields.Item("email").Value) %> 
              <%Session("svlugar")= (rscuestionario.Fields.Item("lugar").Value) %> 
