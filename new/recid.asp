...
rs.Open q, "DSN=7598.medicina;"
  ...
  nombre = rs("nombre").value   %>
                            <table border="0" width="100%">
                              <tr> 
                                <td width="20">&nbsp;</td>
                                <td height="30"> <p><b><font color="#800040">RECETAS: 
                                    </font></b><i><strong><%=nombre%></strong></i>
                                  </p></td>
                              </tr>
                              <tr> 
                                <td width="20" align="right"> <p> </p></td>
                                <td> <p><%=rs("ingredientes")%> 
                                    </p></td>
                              </tr>
                              <tr> 
                    ...
                    <td align="center" valign="top" width="20%"> <table border="0" cellspacing="5" cellpadding="5" width="100%">
                        <tr align="center"> 
