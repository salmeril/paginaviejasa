                    ...
                    <table border="0" width="100%">
                      <tr> 
                        ...
                        <td height="30"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr> 
                              <td><div align="left"><h1>ENFERMEDADES</h1></div></td>
                              <td align="right"><a href="/new/bibliografia.html">BIBLIOGRAFIA</a></td>
                            </tr>
                          </table></td>
                      </tr>
                      <% while NOT rs.EOF %>
                      <tr> 
                        <td width="20" align="right"> <p><img src="/images/bullet.gif" width="6" height="6" /> 
                            </p></td>
                          <td> <div align="left"><a href="enfid.asp?id=<%=RS("id")%>"> 
                              <a href="enfid.asp?id=<%=RS("id")%>"><%=RS("nombre")%></a> 
                            </div>
                            </td>
                      </tr>
                      <%
