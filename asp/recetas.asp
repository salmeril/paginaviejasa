...
q= "SELECT * FROM recetas ORDER BY nombre"
rs.Open q, "DSN=7598.medicina;"

   %></p>
                  <p><%if rs.EOF then%><font face="Verdana, Arial, Helvetica, sans-serif">No 
                    hay ninguna receta</font>&nbsp; <%else%> </p>
                  <table border="0" width="100%">
                    <tr> 
                      <td width="20">&nbsp;</td>
                      <td height="30"> 
                        <p><font face="Arial, Helvetica, sans-serif"><b><font color="#800040">RECETAS</font></b></font> 
                      </td>
                    </tr>
                    <tr> 
                      ...
                      <td> 
                        <table border="0" cellspacing="0" width="95%" cellpadding="2">
                          ...
                          <tr> 
                            ...
                            <td height="25"><a href="recid.asp?id=<%=RS("id")%>"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=RS("nombre")%></font></a> 
                            </td>
                            <%rs.MoveNext 
if NOT rs.EOF then%> 
...
//--></script><!--webbot BOT="GeneratedScript" endspan --><form method="POST" action="recnom.asp" onsubmit="return FrontPage_Form2_Validator(this)" name="FrontPage_Form2" language="JavaScript">
