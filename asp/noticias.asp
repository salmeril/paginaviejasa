...
q= "SELECT * FROM noticias WHERE  id=1"
...
%></p>
            <table width="90%" border="0" cellspacing="0" cellpadding="0">
              <tr align="left"> 
                <td height="40"> 
                  <p><font face="Arial, Helvetica, sans-serif"><b><font color="#800040">NOTICIAS</font></b></font></p>
                </td>
              </tr>
              <tr align="left"> 
                <td> 
                  <p><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b><font color="#004080"><%=RS("titulo")%> 
                    </font></b></font></p>
                </td>
              </tr>
              <tr align="left"> 
              ...
              <tr align="left"> 
                <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%=RS("noticia")%></font></td>
              </tr>
              <tr align="left"> 
                <td height="5">&nbsp;</td>
              </tr>
