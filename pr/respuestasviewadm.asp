...
<html>
<head>
<title>Respuestas no enviadas</title>
    ...
    <td> 
      <table width="100%" border="1" cellspacing="0" cellpadding="0">
        <tr bgcolor="#FF9999"> 
          ...
          <td height="23" bgcolor="#FF9999"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>EMAIL</b></font></td>
          <td height="23"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">.</font></td>
          <td height="23"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">.</font></td>
        </tr>
        <%
While ((Repeat1__numRows <> 0) AND (NOT rsrecomendados.EOF))
%> 
        <% if (rsrecomendados.Fields.Item("enviado").Value)= "no" then %> 
        <tr> 
          ...
          <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=(rsrecomendados.Fields.Item("nombre").Value)%> 
            <%=(rsrecomendados.Fields.Item("apellido").Value)%> </font></td>
          <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=(rsrecomendados.Fields.Item("email").Value)%> 
            </font></td>
          <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><a HREF="respuestasedit.asp?<%= MM_keepNone & MM_joinChar(MM_keepNone) & "ID=" & rsrecomendados.Fields.Item("ID").Value %>">Enviar</a></font></td>
...
%> 
  ...
  <tr> 
    ...
    <td height="5"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><a href="respuestasviewall.asp">Ver 
      todos </a></font></td>
  </tr>
</table>
<p>&nbsp; </p>
