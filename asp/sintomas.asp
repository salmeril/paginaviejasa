...
<title>Enfermedades resultados de busqueda por indice</title>
<!-- #EndEditable --> 
...
q= "SELECT * FROM sintomas INNER JOIN Enfermedades ON sintomas.Enfid = Enfermedades.ID WHERE (sintomas.nombre = '" & nombre & "') ORDER BY enfermedades.nombre"
