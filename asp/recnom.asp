...
<title>Recetas Saludables busqueda</title>
<!-- #EndEditable --> 
...
q= "SELECT * FROM recetas WHERE (nombre LIKE '%" & nombre & "%' OR ingredientes LIKE '%" & nombre & "%') ORDER BY nombre"
...
%> 
                  ...
                  <table border="0" width="100%">
                    ...
                    <tr> 
                      ...
                      <td> 
                        <p><a href="recid.asp?id=<%=RS("id")%>"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=RS("nombre")%></font></a> 
