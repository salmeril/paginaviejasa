...
<title>Respuestas a preguntas frequentes</title>
<!-- #EndEditable --> 
...
q= "SELECT * FROM preguntas WHERE  id=" & Request("id")
rs.Open q, "DSN=7598.medicina;"

  pregunta = rs("pregunta").value   %> 
            <table border="0" width="100%">
              <tr> 
                <td width="20">&nbsp;</td>
                <td height="30"> 
                  <p><font face="Arial, Helvetica, sans-serif"><b><font face="Arial, Helvetica, sans-serif"><b><font color="#800040">PREGUNTAS 
                    FREQUENTES</font></b></font> <font color="#800040">:</font></b></font> 
                  <p><font face="Arial, Helvetica, sans-serif"><font face="Arial" color="#004080"><i><strong><%=pregunta%></strong></i></font></font> 
                </td>
              </tr>
              <tr> 
              ...
              <tr> 
                <td width="20" align="right">&nbsp;</td>
                <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><font color="#666666"></font></b></font></td>
              </tr>
              <tr> 
                <td width="20" align="right">&nbsp;</td>
                <td height="3"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><font color="#666666"></font></b></font></td>
              </tr>
            </table>
          </td>
        </tr>
