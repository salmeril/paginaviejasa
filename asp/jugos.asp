...
q= "SELECT * FROM Jugos ORDER BY nombre"
rs.Open q, "DSN=7598.medicina;"

   %></p>
                  <p><%if rs.EOF then%><font face="Verdana, Arial, Helvetica, sans-serif">No 
                    hay ningun jugo</font>&nbsp; <%else%> </p>
                  <table border="0" width="100%">
                    <tr> 
                      <td width="20">&nbsp;</td>
                      <td height="30"> 
                        <p><font face="Arial, Helvetica, sans-serif"><b><font color="#800040">JUGOS</font></b></font> 
                      </td>
                    </tr>
                    <tr> 
                      ...
                      <td> 
                        <table border="0" cellspacing="0" width="95%" cellpadding="2">
                          <%while NOT rs.EOF%> 
                          <tr> 
                            <td width="10" height="20" align="right"><img src="/images/bullet.gif" width="6" height="6"></td>
                            <td height="25"><a href="jugid.asp?id=<%=RS("id")%>"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=RS("nombre")%></font></a> 
                            </td>
                            <%rs.MoveNext 
if NOT rs.EOF then%> 
                            <td height="25" align="right" width="10"><img src="/images/bullet.gif" width="6" height="6"> 
                            </td>
                            <td height="25"><a href="jugid.asp?id=<%=RS("id")%>"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=RS("nombre")%></font></a> 
                            </td>
                            <%end if%> </tr>
...
function FrontPage_Form2_Validator(theForm)
{
  ...
  {
    alert("Registration Confirmation");
    theForm.nombre2.focus();
    return (false);
  }
  return (true);
}
//--></script><!--webbot BOT="GeneratedScript" endspan --><form method="POST" action="/asp/jugnom.asp" onsubmit="return FrontPage_Form2_Validator(this)" name="FrontPage_Form2" language="JavaScript">
                          <table border="1" cellpadding="0" cellspacing="0" bordercolor="#333366" width="150" height="100">
                            <tr bgcolor="#006FA4"> 
                              <td align="center"><font face="Arial, Helvetica, sans-serif" size="2" color="#FFFFFF">Buscar 
                                por <b>nombre</b> o<br>
                                <b>ingredientes</b></font></td>
                            </tr>
                            <tr bgcolor="#FFDACA"> 
                              <td align="center"><!--webbot bot="Validation" B-Value-Required="TRUE" --> 
                                <input type="text" name="nombre2" size="15">
                                <br>
                                <input type="image" img src="/images/buscar.gif" name="buscar2" border="0" width="80" height="19">
                              </td>
                            </tr>
                          </table>
                        </form>
