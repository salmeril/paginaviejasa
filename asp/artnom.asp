...
<title>Topicos de interes resultado busqueda</title>
<!-- #EndEditable --> 
...
q= "SELECT * FROM articulos WHERE (topico LIKE '%" & nombre & "%' OR keywords LIKE '%" & nombre & "%') ORDER BY topico"
rs.Open q, "DSN=7598.medicina;"
%> 
            <p><%if rs.EOF then%><font face="Verdana, Arial, Helvetica, sans-serif">No 
              hay ningun tópico de interes</font>&nbsp; <%else%> </p>
            <table border="0" width="100%">
              <tr> 
                <td width="20">&nbsp;</td>
                <td height="30"> 
                  <p><font face="Arial, Helvetica, sans-serif"><b><font color="#800040">TOPICOS 
                    DE INTERES</font></b></font> 
                </td>
              </tr>
              <% while NOT rs.EOF %> 
              <tr> 
                ...
                <td> 
                  <p><a href="artid.asp?id=<%=RS("id")%>"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=RS("topico")%></font></a> 
