...
<title>Preguntas frequentes resultado busqueda</title>
<!-- #EndEditable --> 
...
q= "SELECT * FROM preguntas WHERE (pregunta LIKE '%" & nombre & "%' OR keywords LIKE '%" & nombre & "%') ORDER BY pregunta"
rs.Open q, "DSN=7598.medicina;"
%> 
            <p><%if rs.EOF then%><font face="Verdana, Arial, Helvetica, sans-serif">No 
              hay ningun pregunta</font>&nbsp; <%else%> </p>
            <table border="0" width="100%">
              <tr> 
                <td width="20">&nbsp;</td>
                <td height="30"> 
                  <p><font face="Arial, Helvetica, sans-serif"><b><font color="#800040">P</font></b></font><font face="Arial, Helvetica, sans-serif"><b><font color="#800040">REGUNTAS 
                    FREQUENTES</font></b></font> 
                </td>
              </tr>
              <% while NOT rs.EOF %> 
              <tr> 
                ...
                <td> 
                  <p><a href="preid.asp?id=<%=RS("id")%>"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=RS("pregunta")%></font></a> 
