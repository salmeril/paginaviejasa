...
q= "SELECT * FROM recetascaseras WHERE  id=" & Request("id")
rs.Open q, "DSN=7598.medicina;"

  receta = rs("receta").value   %> 
            <table border="0" width="100%">
              <tr> 
                <td width="20">&nbsp;</td>
                <td height="30"> 
                  <p><font face="Arial, Helvetica, sans-serif"><b><font face="Arial, Helvetica, sans-serif"><b><font color="#800040">RECETAS 
                    CASERAS</font></b></font> <font color="#800040">:</font></b></font><br>
                    <font face="Arial, Helvetica, sans-serif"><font face="Arial, Helvetica, sans-serif"><font face="Arial" color="#004080"><i></i></font></font></font> 
                    <font face="Arial, Helvetica, sans-serif"><font face="Arial, Helvetica, sans-serif"><font face="Arial" color="#004080"><i><strong><%=receta%></strong></i></font></font></font> 
                </td>
              </tr>
              <tr>
              ...
              <tr> 
                ...
                <td> 
                  <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=rs("respuesta")%></font> 
              ...
              <tr> 
                <td width="20" align="right">&nbsp;</td>
                <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><font color="#999999"><b><i><font size="1">LAS 
                  RECETAS CASERAS Y LAS INSTRUCCIONES GENERALES SUGERIDAS, NO 
                  INTENTAN SUBSTITUIR LOS SERVICIOS DE UN FACULTATIVO. <br>
                  SI SUFRE ALGUNA ENFERMEDAD CONSULTE A SU MEDICO. <br>
                  NO PARE DE TOMAR NI CAMBIE NINGUN MEDICAMENTO O TRATAMIENTO 
                  PRESCRIPTO POR SU MEDICO PRIMARIO O EL HOSPITAL (SI EL PACIENTE 
                  ES MENOR DE 18 DEBE SER APROBADO POR EL PADRE O GUARDIAN)</font></i></b></font></font><font color="#666666" size="1"></font></b></font></td>
              </tr>
              <tr> 
                <td width="20" align="right">&nbsp;</td>
                <td height="3">&nbsp;</td>
