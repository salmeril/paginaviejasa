...
rs.Open q, "DSN=7598.medicina;"
  ...
  receta = rs("receta").value   %>
                      <table border="0" width="100%">
                        <tr> 
                          <td width="20">&nbsp;</td>
                          <td height="30"> <p align="left"><b><font color="#800040">RECETAS 
                              CASERAS</font></font> <font color="#800040">:</font></b><br />
                              <i><strong><%=receta%></strong></i> </p></td>
                        </tr>
                        <tr> 
                        ...
                        <tr> 
                          ...
                          <td> <p align="left"><%=rs("respuesta")%> </p></td>
                        </tr>
                        <tr> 
                          <td width="20" align="right">&nbsp;</td>
                          <td height="3">&nbsp;</td>
                        ...
                        <tr> 
                          <td width="20" align="right">&nbsp;</td>
                          <td><div align="left"><font color="#999999"><b><i><font size="1">LAS 
                              RECETAS CASERAS Y LAS INSTRUCCIONES GENERALES SUGERIDAS, 
                              NO INTENTAN SUBSTITUIR LOS SERVICIOS DE UN FACULTATIVO. 
                              <br />
                              SI SUFRE ALGUNA ENFERMEDAD CONSULTE A SU MEDICO. 
                              <br />
                              NO PARE DE TOMAR NI CAMBIE NINGUN MEDICAMENTO O 
                              TRATAMIENTO PRESCRIPTO POR SU MEDICO PRIMARIO O 
                              EL HOSPITAL (SI EL PACIENTE ES MENOR DE 18 DEBE 
                              SER APROBADO POR EL PADRE O GUARDIAN)</font></i></b></font></div></td>
                        </tr>
                        <tr> 
                          <td width="20" align="right">&nbsp;</td>
                          <td height="3">&nbsp;</td>
