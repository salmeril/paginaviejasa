...
q= "SELECT * FROM articulos WHERE  id=" & Request("id")
rs.Open q, "DSN=7598.medicina;"

topico = rs("topico").value   %> 
            <table border="0" width="100%">
              <tr> 
                <td width="20">&nbsp;</td>
                <td height="30"> 
                  <p><font face="Arial, Helvetica, sans-serif"><b><font face="Arial, Helvetica, sans-serif"><b><font color="#800040">TOPICOS 
                    DE INTERES</font></b></font> <font color="#800040">:</font></b></font> 
                  <p><font face="Arial, Helvetica, sans-serif"><font face="Arial" color="#004080"><i><strong><%=topico%></strong></i></font></font> 
                </td>
              </tr>
              <tr> 
                ...
                <td> 
                  <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=rs("articulo")%></font> 
