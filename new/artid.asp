...
topico = rs("topico").value   %>
                      <table border="0" width="100%">
                        <tr> 
                          <td width="20">&nbsp;</td>
                          <td height="30"> <p align="left"><b><font color="#800040">TOPICOS 
                              DE INTERES</font></b><font color="#800040">:</font> 
                            </p>
                            <p align="left"><i><strong><%=topico%></strong></i> </p></td>
                        </tr>
                        <tr> 
                          <td width="20" align="right"> <p> </p></td>
                          <td> <p align="left"><%=rs("articulo")%> </p></td>
                        </tr>
                        <tr> 
