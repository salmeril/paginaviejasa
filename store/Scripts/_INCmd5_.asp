...
'*************************************************************************
'
' The code below is based on MD5 routines developed by the kind folks 
' at http://www.frez.co.uk, with some modifications by CandyPress.Com.
'
