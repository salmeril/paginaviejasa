...
%> 
        <tr> 
          ...
          <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><A HREF="respuestasdetail.asp?<%= MM_keepNone & MM_joinChar(MM_keepNone) & "ID=" & rsrecomendados.Fields.Item("ID").Value %>">Ver</A></font></td>
        </tr>
        <%
