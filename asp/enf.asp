...
<title>Enfermedades busqueda por nombre o sintoma</title>
<!-- #EndEditable --> 
...
q= "SELECT * FROM enfermedades WHERE (nombre LIKE '%" & nombre & "%' OR contenido1 LIKE '%" & nombre & "%' OR contenido2 LIKE '%" & nombre & "%') ORDER BY nombre"
