...
<table border="0" width="100%">
  <tr> 
    ...
    <td height="5" align="right"> 
      <div align="center"><font face="Verdana, Arial, Helvetica, sans-serif"><b><font color="#33CCCC">ORDENES 
        no aprobadas</font></b></font></div>
    </td>
  </tr>
  <tr> 
    <td width="20"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;</font></td>
    ...
    <td> 
      <table width="100%" border="1" cellspacing="0" cellpadding="0">
        <tr bgcolor="#33CCCC"> 
          ...
          <td height="23" bgcolor="#33CCCC"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>NOMBRE</b></font></td>
...
%> <% if (rsordenes.Fields.Item("aprobado").Value)= "no" then %>
        <tr> 
          ...
          <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><A HREF="ordendetail.asp?<%= MM_keepNone & MM_joinChar(MM_keepNone) & "ID=" & rsordenes.Fields.Item("ID").Value %>">Ver</A></font></td>
          ...
          <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><A HREF="ordendel.asp?<%= MM_keepNone & MM_joinChar(MM_keepNone) & "ID=" & rsordenes.Fields.Item("ID").Value %>">Borrar</A></font></td>
        </tr><%end if%>
        <%
...
%> 
  ...
  <tr> 
    ...
    <td height="5"><a href="ordenall.asp">todas las ordenes</a></td>
  </tr>
</table>
<p>&nbsp; </p>
</body>
