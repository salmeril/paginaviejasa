...
q= "SELECT * FROM radios WHERE  id=" & Request("id")
...
%> 
            <table border="0" width="100%">
              <tr> 
                <td width="20">&nbsp;</td>
                <td height="30"> 
                  <p><font face="Arial, Helvetica, sans-serif"><b><font color="#800040">PROGRAMAS 
                    DE RADIO Y TELEVISION</font><font color="#800040"> </font></b><font face="Arial" color="#004080"><i></i></font></font> 
                </td>
              </tr>
              <tr> 
                ...
                <td> 
                  <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><%=rs("estado")%></b></font> 
                  <p> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=rs("contenido")%></font> 
