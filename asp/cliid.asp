...
<title>Direccion y horario de clinicas</title>
<!-- #EndEditable --> 
...
q= "SELECT * FROM clinicas WHERE  id=" & Request("id")
...
%> 
                  <table border="0" width="100%">
                    <tr> 
                      <td width="20">&nbsp;</td>
                      <td height="30"> 
                        <p><font face="Arial, Helvetica, sans-serif"><b><font face="Arial, Helvetica, sans-serif"><b><font color="#800040">CLINICAS</font></b></font> 
                          <font color="#800040"> </font></b><font face="Arial" color="#004080"><i></i></font></font> 
                      </td>
                    </tr>
                    <tr> 
                      <td width="20" align="right" height="153"> 
                        <p><font face="Verdana, Arial, Helvetica, sans-serif"> 
                          </font> 
                      </td>
                      <td> 
                        <p><font face="Arial, Helvetica, sans-serif"><font face="Arial, Helvetica, sans-serif"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><%=rs("estado")%></b></font></font><b><font face="Arial" color="#004080"><br>
                          </font><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=rs("nombre")%></font></b></font> 
                        <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                          <%=rs("direccion")%></font> <br>
                          <font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=rs("ciudad")%>, 
                          <%=rs("state")%> <%=rs("codigo")%></font> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                          &nbsp;&nbsp; <%=rs("referencia")%><br>
                          </font><font size="2"><%if ltrim(rs("tel"))<>"" then%></font><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Tel: 
                          <%=rs("tel")%></font><font size="2"><%end if%></font><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><br>
                          </font><font size="2"><%if ltrim(rs("fax"))<>"" then%></font><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Fax: 
                          <%=rs("fax")%></font><font size="2"><%end if%></font> 
                        <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                          </font><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=rs("horario")%></font><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><br>
                          </font> 
                      </td>
                    </tr>
                    <tr> 
                      <td width="20" align="right">&nbsp;</td>
                      <td height="5"><img src="<%=rs("adicional")%>"></td>
                    </tr>
                  </table>
                </td>
              </tr>
          ...
          <td align="center" valign="top" width="20%"> 
            <table border="0" cellspacing="5" cellpadding="5" width="100%">
              <tr align="center"> 
                <td height="30"><font face="Arial" color="#000080"><strong></strong></font></td>
              </tr>
              <tr align="center"> 
                <td width="150"><%if trim(rs("foto")) <>"" then%> 
                  <p><img src="<%=rs("foto")%>"></p>
                  <p><%end if%> 
                </td>
              </tr>
