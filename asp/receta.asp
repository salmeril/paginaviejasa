...
<title>Recetas Saludables link</title>
<!-- #EndEditable --> 
...
q= "SELECT * FROM recetas WHERE nombre='" & Request("nombre")& "'"
  ...
  nombre = rs("nombre").value   %> 
                  <table border="0" width="100%">
                    <tr> 
                      <td width="20">&nbsp;</td>
                      <td height="30"> 
                        <p><font face="Arial, Helvetica, sans-serif"><b><font color="#800040">RECETAS: 
