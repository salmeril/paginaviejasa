...
<title>Clinicas resultados busqueda</title>
<!-- #EndEditable --> 
...
q= "SELECT * FROM clinicas WHERE (nombre LIKE '%" & nombre & "%' OR estado LIKE '%" & nombre & "%') ORDER BY estado"
rs.Open q, "DSN=7598.medicina;"
%> 
            <p><%if rs.EOF then%><font face="Verdana, Arial, Helvetica, sans-serif">No 
              hay ningun </font><font face="Verdana, Arial, Helvetica, sans-serif"> 
              clinica</font>&nbsp; <%else%> </p>
            <table border="0" width="100%">
              <tr> 
                <td width="20">&nbsp;</td>
                <td height="30"> 
                  <p><font face="Arial, Helvetica, sans-serif"><b></b></font><font face="Arial, Helvetica, sans-serif"><b><font color="#800040">CLINICAS</font></b></font> 
                </td>
              </tr>
              <% while NOT rs.EOF %> 
              <tr> 
