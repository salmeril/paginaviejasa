  ...
  <tr> 
    ...
    <td> 
      <table width="100%" border="1" cellspacing="0" cellpadding="0">
        <tr bgcolor="#3399CC"> 
          <td width="30" height="24"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>ID</b></font></td>
          <td height="24"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>NOMBRE</b></font></td>
          <td height="24"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>EMAIL</b></font></td>
          <td height="24">Respondido</td>
          <td height="24"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">.</font></td>
          <td height="24"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">.</font></td>
        </tr>
        <%
...
%> 
        <tr> 
          ...
          <td><%=(rscuestionarios.Fields.Item("respondido").Value)%></td>
          ...
          <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><A HREF="cuestionariodeladm.asp?<%= MM_keepNone & MM_joinChar(MM_keepNone) & "ID=" & rscuestionarios.Fields.Item("ID").Value %>">Borrar</A></font></td>
        </tr>
        <%
