...
<title>Jugos resultado busqueda</title>
<!-- #EndEditable --> 
...
q= "SELECT * FROM jugos WHERE (nombre LIKE '%" & nombre & "%' OR ingredientes LIKE '%" & nombre & "%') ORDER BY nombre"
...
%> 
                  ...
                  <table border="0" width="100%">
                    ...
                    <tr> 
                      ...
                      <td> 
                        <p><a href="jugid.asp?id=<%=RS("id")%>"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=RS("nombre")%></font></a> 
