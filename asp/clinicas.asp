...
<title>Clinicas Natural Power</title>
<!-- #EndEditable --> 
...
q= "SELECT * FROM clinicas ORDER BY estado"
rs.Open q, "DSN=7598.medicina;"

   %> 
            <p><%if rs.EOF then%><font face="Verdana, Arial, Helvetica, sans-serif">No 
              hay ninguna clinica</font>&nbsp; <%else%> </p>
            <table border="0" width="100%">
              <tr> 
                <td width="20">&nbsp;</td>
                <td height="30"><font face="Arial, Helvetica, sans-serif"><b><font color="#800040">CLINICAS</font></b></font> 
                </td>
              </tr>
              <% while NOT rs.EOF %> 
              <tr> 
                ...
                <td> 
                  <p><a href="cliid.asp?id=<%=RS("id")%>"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=RS("estado")%></font></a> 
                </td>
              </tr>
              <%
                rs.MoveNext
                ...
                <td height="5" align="center"> 
                  <table width="90%" border="0" cellpadding="5" cellspacing="5">
                    <tr align="center" bgcolor="#DEDEEF"> 
                      <td><font color="#004080" face="Verdana, Arial, Helvetica, sans-serif">Teléfono 
                        de llamada gratis para todo el país <b>1-800-522-7099</b></font> 
