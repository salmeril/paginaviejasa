...
If (CStr(Request("MM_insert")) <> "") Then
  ...
  MM_fields = "fecha,fecha,#,none,NULL,id,ID,none,none,NULL,enviado,enviado,',none,'',lugar,lugar,',none,'',nombre,nombre,',none,'',apellido,apellido,',none,'',email,email,',none,'',contestacion,contestacion,',none,'',productos,productos,',none,'',total,total,none,none,NULL"
  MM_redirectPage = "responder1.asp"
...
<table border="0" width="100%">
  <tr> 
    <td width="20">&nbsp;</td>
    <td height="5"><font face="Verdana, Arial, Helvetica, sans-serif"><b>RESPUESTA</b></font></td>
  </tr>
  <tr> 
    <td width="20">&nbsp;</td>
    <td height="30"> 
    ...
    <td> 
      <form name="productos recomendados" method="post" action="<%=MM_editAction%>">
        <p><font face="Verdana, Arial, Helvetica, sans-serif"><b> 
          ...
          <input type="hidden" name="lugar" value="<%=session("svlugar")%>">
          </b></font></p>
        ...
        <p> 
          <input type="submit" name="agregar" value="ENVIAR" onClick="MM_validateForm('nombre','','R','email','','RisEmail','contestacion','','R');return document.MM_returnValue">
        </p>
